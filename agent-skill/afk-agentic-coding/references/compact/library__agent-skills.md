...
Configure, secure, and operate AFK agent skills with runtime-bound skill tools.

Source: `docs/library/agent-skills.mdx`
...
- Each skill must exist at `//SKILL.md`.
...
- `read_skill_md`: reads `/SKILL.md` for one skill.
